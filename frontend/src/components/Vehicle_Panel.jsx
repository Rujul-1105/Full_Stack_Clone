  ...
  return (
    <div className="bg-white">
      ...
      <div
        ...
        className="flex border-1 active:border-black mb-2 active:border-2 rounded-xl w-full p-3  items-center justify-between"
      >
        <img
          className="h-10"
      ...
      <div
        ...
        className="flex border-1 active:border-black active:border-2 mb-2 rounded-xl w-full p-3  items-center justify-between"
      >
        <img
          className="h-10"
